...
public class CONSULTATIONS {
    ...
    public CONSULTATIONS(int id, int doctor_id, int patient_id, LocalDateTime request_time, LocalDateTime consultation_time, String status, String diagnosis, int rating) {
        this.id = id;
